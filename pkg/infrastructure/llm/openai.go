...
func NewOpenAIProviderClient(provider string) ProviderClient {
	return &openaiProviderClient{provider: provider}
}

func (o *openaiProviderClient) Call(ctx context.Context, model, apiKey, prompt, customURL string) ([]byte, error) {
	var baseURL string
