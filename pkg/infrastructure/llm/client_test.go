...
func TestGetNextLowerModel(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "gemini-2.5-pro falls back to gemini-1.5-pro",
			provider:     "gemini",
			currentModel: "gemini-2.5-pro",
			wantModel:    "gemini-1.5-pro",
		},
		{
			name:         "models/gemini-2.5-pro falls back to gemini-1.5-pro",
			provider:     "Gemini",
			currentModel: "models/gemini-2.5-pro",
			wantModel:    "gemini-1.5-pro",
		},
		{
			name:         "gemini-1.5-pro falls back to gemini-2.5-flash",
			provider:     "gemini",
