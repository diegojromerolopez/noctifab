...
See [`validation/README.md`](validation/README.md) and [`docs/validation_project_loop.md`](docs/validation_project_loop.md) for full setup and credential details.
