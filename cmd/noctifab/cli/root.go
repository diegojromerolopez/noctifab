...
func init() {
	...
	RootCmd.PersistentFlags().Bool("ci-auto-fix", false, "Automatically attempt to fix CI pipeline failures")
	RootCmd.PersistentFlags().Int("ci-max-retries", 3, "Max attempts to fix CI before giving up")
